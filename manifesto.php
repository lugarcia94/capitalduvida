...
<section class="manifest__first">
   ...
   <span class="ppeditorlightitalic">Muita vezes tudo começa com um <strong>“e se?”</strong></span>
...
<section class="manifest__first three">
   ...
   <p>Sim, dúvidas, por mais irônico que possa parecer, têm sido as maiores alavancas da criatividade desde a invenção da roda. 
   </p>

   <p>E num mundo com cada vez menos certezas, o mundo areia-movediça em que vivemos agora, elas se tornam fundamentais não só para grandes inventores, mas também para todos que desejam viver a vida que querem.  
   </p>
